  ...
  return (
    <PageAnimated>
      <Container className="welcome-page">
        ...
        <div
          className={clsx('welcome-bottom-section', { loaded: imageLoaded })}
        >
          ...
          <p className="explanation-disclaimer-text">
            ...
            answers on a scale of 0 to 6. Your total score will give insight
            into your emotional health, ranging from minimal to severe
            depression.
          </p>
          <p className="explanation-disclaimer-text">
            Start when you're ready, and remember, the results are not a
            clinical diagnosis but a helpful guideline.
          </p>
        </div>
